                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0" id="DT-default" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="content-visibility: hidden;"><?= $value["candidate_id"] ?></td>
                                                    <td><?= $key + 1 ?></td>
                                                    <td><?= $value["code"] ?></td>
                                                    <td><?= $value["name"] ?></td>
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex" style="justify-content: center;">
                                                            ...
                                                            <li>
                                                                <a href="#deleteModal" data-toggle="modal" class="remove" onclick="setDeleteId(<?= $value['candidate_id']; ?>)">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" action=<?= route_to("hrd.candidate.store") ?> method="POST">
                    <div class="form-group">
                        <label for="kode">Kode</label>
                        <input type="text" class="form-control" id="kode" name="kode" placeholder="Enter candidate name">
                    </div>
                    <div class="form-group">
                        <label for="namaKandidat">Nama Kandidate/Pelamar</label>
                        <input type="text" class="form-control" id="namaKandidat" name="namaKandidat" placeholder="Enter candidate name">
                    </div>
                    <div class="form-group">
...
<div id="editModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action=<?= route_to("hrd.candidate.update") ?> method="POST">
                    <input type="hidden" id="editId" name="editId">
                    <div class="form-group">
                        <label for="editKode">Kode</label>
                        <input type="text" class="form-control" id="editKode" name="editKode" placeholder="Enter candidate name">
                    </div>
                    <div class="form-group">
                        <label for="editNamaKandidat">Nama Kandidate/Pelamar</label>
                        <input type="text" class="form-control" id="editNamaKandidat" name="editNamaKandidat" placeholder="Enter candidate name">
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $(".edit").click(function() {
            ...
            let namaKandidat = row.find("td:eq(3)").text();
            let deskripsi = row.find("td:eq(4)").text();

            $("#editId").val(id);
            $("#editKode").val(kode);
            $("#editNamaKandidat").val(namaKandidat);
    ...
    function submitDelete() {
        let id = $("#deleteId").val();
        window.location.href = "<?= base_url('hrd/candidate/delete') ?>/" + id;
    }
</script>